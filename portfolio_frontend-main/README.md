...
The project has been deployed as 'infrastructure as code' (IaaC) and the tool that has been used for that is AWS CDK (Cloud development kit). This repository includes the CDK app source code. 
